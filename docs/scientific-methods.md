...
- Transport Cost (Conduction Delay): Sum of path lengths from each root tip to the base—represents resource transport efficiency
...
Implementation: `pareto_functions.py`, function `pareto_cost()`
...
Implementation: `pareto_functions.py`, function `pareto_front()`
...
Implementation: `quantify.py`, function `distance_from_front()`
...
Implementation: `pareto_functions.py`, function `pareto_cost_3d_path_tortuosity()`
...
Implementation: `quantify.py`, function `distance_from_front_3d()`
...
Implementation: `quantify.py`, within function `distance_from_front_3d()`
...
1. Start with critical nodes (base node + all root tips)
...
Implementation:
- 2D: `pareto_functions.py`, function `random_tree()`
- 3D: `pareto_functions.py`, function `random_tree_3d_path_tortuosity()`
...
4. Conn, A., Chandrasekhar, A., van Rongen, M., Leyser, O., Chory, J., & Navlakha, S. (2019). "Network trade-offs and homeostasis in Arabidopsis shoot architectures." PLOS Computational Biology, 15(9), e1007325.
   - DOI: https://doi.org/10.1371/journal.pcbi.1007325
   - Network trade-off analysis methodology
...
|-------------|------|----------|
| 2D Pareto cost | `pareto_functions.py` | `pareto_cost()` |
| 3D Pareto cost | `pareto_functions.py` | `pareto_cost_3d_path_tortuosity()` |
| 2D distance to front | `quantify.py` | `distance_from_front()` |
| 3D distance to front | `quantify.py` | `distance_from_front_3d()` |
| Random tree (2D) | `pareto_functions.py` | `random_tree()` |
| Random tree (3D) | `pareto_functions.py` | `random_tree_3d_path_tortuosity()` |